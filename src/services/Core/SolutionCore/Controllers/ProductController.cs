...
namespace SolutionCore.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
       ...
       private IProductContract _IProductContract;
        ...
        {
            //var xx = HttpContext.User.Identity;
            //string tokenResult = Request.Headers["Authorization"].ToString();
            //var token = tokenResult.Split(" ");
            //var read_token = new JwtSecurityTokenHandler().ReadJwtToken(token[1]);
            ////var claim = read_token.Claims.First(c => c.Type == "role").Value;
